...
<body>
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container-fluid">
            <a class="navbar-brand text-dark" style="font-weight: bold;" href="#">Teman<span>Baca</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="font-weight: bold;">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <form class="d-flex" role="search" action="{{ route('posts.index') }}" method="GET">
                        <input class="form-control me-2" type="search" name="search" placeholder="Search title..." aria-label="Search" value="{{ request('search') }}">

                        <!-- Dropdown untuk filter sortir -->
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{route('posts.create')}}"><i class="bi bi-pencil-square"></i> Write</a>
                    </li>
    ...
    <!-- Bootstrap JS (pastikan versi sesuai) -->
